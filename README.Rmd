...
[![Downloads](http://cranlogs.r-pkg.org/badges/survminer)](http://cran.rstudio.com/package=survminer)
...
```{r ggplot2-basic-survival-plot, fig.height = 4, fig.width = 4}
ggsurvplot(fit)
```
    
    
3. **Customized survival curves**
    
    
  
```{r ggplot2-customized-survival-plot, fig.height = 5, fig.width = 5}
