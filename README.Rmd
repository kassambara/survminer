...
```{r ggplot2-basic-survival-plot-pval-logical, fig.height = 4, fig.width = 5}
ggsurvplot(fit, data = lung, pval = TRUE)
```

It is also possible to specify custom p-value, with numeric:

```{r ggplot2-basic-survival-plot-pval-num, fig.height = 4, fig.width = 5}
ggsurvplot(fit, data = lung, pval = 0.03)
```

or a personalized character:

```{r ggplot2-basic-survival-plot-pval-char, fig.height = 4, fig.width = 5}
...
```{r ggplot2-basic-survival-plot-pval-weighted, fig.height = 4, fig.width = 5}
ggsurvplot(
  fit,
  data = lung,
  pval = TRUE,
