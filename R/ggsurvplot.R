...
#'
#'@description Core function to plot survival curves using ggplot2.  Accepts
#'  only one survfit object. Internally called by the other
#'  \code{ggsurvplot_*()} family functions.
